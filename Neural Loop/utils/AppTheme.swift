...
enum AppTheme {
    ...
    // Semantic Colors
    static let workEventTint = Color.adaptive(
        light: Color(red: 0.14, green: 0.49, blue: 0.53),
        dark: Color(red: 0.22, green: 0.67, blue: 0.60)
    )
    static let taskEventTint = Color.adaptive(
        light: Color(red: 0.95, green: 0.60, blue: 0.10),
        dark: Color(red: 0.99, green: 0.80, blue: 0.45)
    )
    static let habitEventTint = Color.adaptive(
        light: Color(red: 0.30, green: 0.70, blue: 0.30),
        dark: Color(red: 0.40, green: 0.80, blue: 0.40)
    )
    
    static let workEventGradientColors: [Color] = [
        Color(red: 0.14, green: 0.49, blue: 0.53),
        Color(red: 0.22, green: 0.67, blue: 0.60)
    ]
    
    static let warningTint = Color.adaptive(light: .orange, dark: Color(red: 0.93, green: 0.79, blue: 0.43))
    static let successTint = Color.adaptive(light: .green, dark: .mint)
